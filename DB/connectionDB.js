...
insertMusic( author, music){
    mysqlConnection.query(`INSERT INTO MUSICA (CODIGO, NOME, CANAL, USUARIO, DURACAO, VISUALIZACAO, LINK) VALUES ('${music['id']}', '${music['title']}', '${music['author']}', '${author}', '${music['duration']}', '${music['views']}', '${music['url']}');`)   
